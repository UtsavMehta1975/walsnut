...
export default function SignInPage() {
  ...
  const handleGoogleSignIn = async () => {
    try {
      setIsLoading(true)
      // Use NextAuth's signIn method for Google OAuth
      await signIn('google', { 
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="mt-6">
            <Button
              ...
              disabled={isLoading}
              className="w-full bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 disabled:opacity-75 transition-all duration-200 flex items-center justify-center gap-3"
            >
